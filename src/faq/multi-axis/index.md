...
Users are encouraged to refer to the sample code in the latest [**ScottPlot Cookbook: Multi-Axis**](https://swharden.com/scottplot/cookbooks/4.1.9-beta/#multi-axis) section for version-specific syntax information.
...
👉 See [**ScottPlot Cookbook: Multi-Axis**](https://swharden.com/scottplot/cookbooks/4.1.9-beta/#multi-axis) for additional examples with full source code
